...
export async function mountJevDebug({snapshot,pause,resume,jump}) {
  const button=document.createElement('button');
  button.className='jev-toggle'; button.textContent='Jev · 실험';
  ...
  button.onclick=()=>{pause();refresh();dialog.showModal();};
  ...
  try {
    ...
    enabled=response.ok&&data.enabled===true&&data.mode==='shadow';
